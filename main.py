...
all_pages = {
    ...
    "📚 程式練習": [
        ...
        st.Page("pages/class5-5.py", title="對話輸入", icon="✍️"),
        st.Page("pages/class5-6.py", title="對話AI機器人", icon="🤖"),
        st.Page("pages/class5-7.py", title="圖片上傳", icon="🖼️"),
        st.Page("pages/class5-8.py", title="AI圖片辨識", icon="🔎"),
        st.Page("pages/class5-9.py", title="網路載入動畫", icon="⌛"),
        st.Page("pages/class5-10.py", title="AI圖片生成", icon="🖼️"),
    ],
}
